...
inline long long SYSCALL(maInvokeExtension) (int function, int a, int b, int c) {
	int ret;
	convertRet<longlong>(ret, __dbl_high, (longlong) SYSCALL_IMPL(maInvokeExtension)(convertSingleArg<int>(function), convertSingleArg<int>(a), convertSingleArg<int>(b), convertSingleArg<int>(c)));
	return ret;
}
